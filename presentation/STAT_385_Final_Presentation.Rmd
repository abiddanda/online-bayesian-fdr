...
<center>
<img src="img/general_intro.jpg" width="325" height="325" style="background:none; border:none; box-shadow:none;">
</center>
...
Previous methods for controlling the FDR in online settings use heuristics that can readily make decisions at each time point. Some of these methods include:
...
<center>
<img src="img/thinking.jpg" width="200" height="150" style="background:none; border:none; box-shadow:none;">
</center>
...
<i>
Our approach provides the ability to sample from the posterior of previous $Z_{t<T}$ when esimtating the mixture model rather than fixing the number of discoveries as in LBOND and LBORD.
</i>
